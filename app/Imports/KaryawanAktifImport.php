...
class KaryawanAktifImport implements ToCollection, WithHeadingRow, WithStartRow
{
    private $lastId;
    private $rowNumber;
    ...
    public function collection(Collection $rows)
    {
        foreach ($rows as $row) {
            ...
            $existingkaryawan = MasterAktif::where('karyawan_id', $row['id'])->first();
