...
<main id="main" class="main">
    ...
    <section class="section dashboard">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <a href="{{route('superadmin.akunuser.create')}}" class="btn btn-sm btn-primary mb-3 mt-3">Tambah Akun User</a>
                ...
                <table class="table">
                  ...
                  <tbody>
                        ...
                        <td>{{$item->email}}</td>
                        <td> <a href="{{ route('detailposisi', $item->id) }}" class="detail-member">Lihat posisi</a></td> 
                        <td>
    <!-- Edit Button -->
    <a href="{{ route('superadminshowakununser', $item->id) }}" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" title="Edit">
        <i class="bi bi-pencil"></i>
    </a>
    
    <!-- Delete Button Form -->
    <form method="POST" action="{{ route('superadmindeleteuser', $item->id) }}" style="display: inline;">
        @csrf
        @method('DELETE')
    ...
    <form action="{{ route('reset-password', ['user' => $item->id]) }}" method="POST" style="display: inline;">
        @csrf
        <button type="submit" class="btn btn-sm btn-secondary show_confirm2" data-bs-toggle="tooltip" title="Reset Password">
            <i class="bi bi-key"></i>
        </button>
    </form>
</td>
