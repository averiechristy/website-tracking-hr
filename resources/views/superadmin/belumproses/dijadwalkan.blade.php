...
<div class="pagetitle">
  <h1>Kandidat Baru (Sudah Dijadwalkan)</h1>
</div>
...
<button type="button" class="btn btn-warning btn-sm mr-2 mt-2" onclick="handleAction('stop proses', {{ $item->id }})"{{ $item->hasil_status !== 'Dijadwalkan' ? 'disabled' : '' }}>Stop Proses</button>
<button type="button" class="btn btn-primary btn-sm mr-2 mt-2" onclick="handleAction('reschedule', {{ $item->id }})"{{ $item->flag_schedule === 'Rescheduled' ? 'disabled' : '' }}>Reschedule</button>
