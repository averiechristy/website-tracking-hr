...
<div class="pagetitle">
  <h1>Interview HR (Belum Dijadwalkan)</h1>
</div>
...
<form method="GET" action="{{ route('superadmin.itvhr.index') }}" class="mb-3 mt-4">
    <div class="row">
    <div class="col-md-4">
...
function processStatus() {
    ...
    window.location.href = "{{ route('superadmin.penjadwalanitvhr') }}?ids=" + checkedIds.join(',');
}
