...
<div class="pagetitle">
  <h1>Interview User 2 (Sedang Dijadwalkan)</h1>
</div>
...
<form method="GET" action="{{ route('superadmin.itvuserdua.index') }}" class="mb-3 mt-4">
    <div class="row">
    <div class="col-md-4">
...
function saveReschedule() {
    ...
    fetch("{{ route('create-log-tahapanitvuserdua') }}", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '{{ csrf_token() }}'
