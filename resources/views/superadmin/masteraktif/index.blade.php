    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <h6 class="mt-2">Import Data Karyawan Aktif</h6>
          <div class="importdata mt-4 mb-4">
    <form id="upload-form" action="{{ route('importkaryawanaktif') }}" method="post" enctype="multipart/form-data" style="display: flex; align-items: center;">
        @csrf
              ...
              <tbody>
               ...
               <tr>
                ...
                <td>
                  ...
                  <!-- Delete Button Form -->
    <form method="POST" action="{{ route('deletekaryawanaktif', $item->id) }}" style="display: inline;">
        @csrf
        @method('DELETE')
