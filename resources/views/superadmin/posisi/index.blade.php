...
<section class="section dashboard">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <a href="{{route('superadmin.posisi.create')}}" class="btn btn-sm btn-primary mb-3 mt-3">Tambah Posisi</a>
            ...
            <table class="table">
              ...
              @foreach ($posisis as $item)
                <tr>
                  ...
                  <td>
                    <a  href="{{ route('superadminshowposisi', $item->id) }}" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" title="Edit">
                        <i class="bi bi-pencil"></i>
                    </a>
                    <form method="POST" action="{{ route('superadmindeleteposisi', $item->id) }}" style="display: inline;">
                @csrf
                @method('DELETE')
