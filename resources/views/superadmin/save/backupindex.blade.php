...
<div class="pagetitle">
  <h1>Simpan Kandidat</h1>
</div>
@include('components.alert')          
<form method="POST" action="{{ route('superadmin.save.process') }}" id="processForm">
    @csrf

    <div class="row mb-2">
    <div class="col-md-4">
        <select name="posisi_ganti" class="form-select" required>
    ...
    <div class="col-md-4">
        <select name="wilayah_ganti" class="form-select" required>
    ...
    <!-- Tambahkan input hidden untuk checked_ids -->
    ...
    <div class="d-flex align-items-center mb-3">
        ...
        <!-- Pindahkan event submit ke tombol -->
        <button id="processButton" type="button" class="btn btn-primary" onclick="processStatus()">Proses</button>
    </div>
</form>
...
<form method="GET" action="{{ route('superadmin.save.index') }}" class="mb-3 mt-4">
    <div class="row">
    <div class="col-md-4">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="mundurkanStatusForm" method="POST" action="{{ route('superadmin.lolos.mundurkanStatus') }}">
          @csrf
...
function processStatus() {
    ...
    let posisi =document.forms["processForm"]["posisi_ganti"].value.trim();
    let wilayah = document.forms["processForm"]["wilayah_ganti"].value.trim();
