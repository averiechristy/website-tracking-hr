...
<section class="section dashboard">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <a href="{{route('superadmin.sumber.create')}}" class="btn btn-sm btn-primary mb-3 mt-3">Tambah Sumber</a>
            ...
            <table class="table">
              ...
              @foreach ($sumbers as $item)
                <tr>
                  ...
                  <td>
                    <a  href="{{ route('superadminshowsumber', $item->id) }}" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" title="Edit">
                        <i class="bi bi-pencil"></i>
                    </a>
                    <form method="POST" action="{{ route('superadmindeletesumber', $item->id) }}" style="display: inline;">
                @csrf
                @method('DELETE')
