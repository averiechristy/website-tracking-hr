...
<div class="pagetitle">
  <h1>Training (Belum Dijadwalkan)</h1>
</div>
...
<form method="GET" action="{{ route('superadmin.training.index') }}" class="mb-3 mt-4">
    <div class="row">
    <div class="col-md-4">
...
function processStatus() {
    ...
    window.location.href = "{{ route('superadmin.penjadwalantraining') }}?ids=" + checkedIds.join(',');
}
