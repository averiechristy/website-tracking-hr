...
<section class="section dashboard">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <a href="{{route('superadmin.wilayah.create')}}" class="btn btn-sm btn-primary mb-3 mt-3">Tambah Wilayah</a>
            ...
            <table class="table">
              ...
              @foreach ($wilayah as $item)
                <tr>
                  ...
                  <td>
                    <a  href="{{ route('superadminshowwilayah', $item->id) }}" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" title="Edit">
                        <i class="bi bi-pencil"></i>
                    </a>
                    <form method="POST" action="{{ route('superadmindeletewilayah', $item->id) }}" style="display: inline;">
                @csrf
                @method('DELETE')
